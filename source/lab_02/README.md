...
### План работы:
 ...
 - Выполнить практическую часть — убедиться в наличии связности устройств в OSPF домене. 
...
| [spine.j2](netlab/spine.j2) | шаблон конфигурации Spine 1..2. |
| [leaf.j2](netlab/leaf.j2) | шаблон конфигурации Leaf 1..3. |
| [bfd.j2](netlab/bfd.j2) | шаблон конфигурации BFD для всех. |
| [ospf-timers.j2](netlab/ospf-timers.j2) | шаблон конфигурации OSPF таймеров для всех. |
| [leaf.png](netlab/leaf.png) | изображение leaf. |
| [spine.png](netlab/spine.png.png) | изображение spine. |
...
В созданном каталоге выполнм команду:
```shell
$ netlab up
```
...
Проверяем доступность Leaf 3 из Leaf 1:
<details>
<summary>cli</summary>
...
Выполниим захват трафика на Leaf 1 в Wireshark ([как настроить перенаправление захвата](../setup/README.md#перенаправление-захваченного-трафика-в-wireshark)):
```
...
![image](images/capture_ospf_hello_leaf1.png)
  ...
  \
Выполним перезагрузку узла чтобы проверить установление соседства (подходит только для Leaf'ов):
Перезагрузка узла:
```
...
<details>
<summary>Выполним down/up интерфейсов на Spine чтобы проверить обновление маршрутов:</summary>
