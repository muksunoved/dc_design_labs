#!/bin/bash
# Host2 startup configuration — applied by netlab files plugin
# eth1 connects to leaf2 (VLAN 10 access port — VXLAN overlay)
...
ip addr add 192.168.10.12/24 dev eth1 2>/dev/null || true
ip link set eth1 up
